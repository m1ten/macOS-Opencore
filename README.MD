...
- Added a USB Map (Necessary for USB 2.0 hot-plug while using the HDMI port)
- Experimental HDMI Support: *see notes for tutorial*
...
- Notes:
- - HDMI hot-plug will take multiple attempts before initiating
